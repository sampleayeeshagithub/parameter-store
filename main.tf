...
# Roboshop dev env
    { name = "dev.roboshop.frontend.catalogue_url", value = "http://catalogue-dev.ayeeshadevops75.online:80/", type = "String" },
    { name = "dev.roboshop.frontend.cart_url", value = "http://cart-dev.ayeeshadevops75.online:80/", type = "String" },
    { name = "dev.roboshop.frontend.user_url", value = "http://user-dev.ayeeshadevops75.online:80/", type = "String" },
    { name = "dev.roboshop.frontend.shipping_url", value = "http://shipping-dev.ayeeshadevops75.online:80/", type = "String" },
    { name = "dev.roboshop.frontend.payment_url", value = "http://payment-dev.ayeeshadevops75.online:80/", type = "String" },
    ...
    { name = "dev.roboshop.user.MONGO_URL", value = "mongodb://docdbadmin:RoboShop1234@dev-docdb-cluster.cluster-cmzmzlxo5mcv.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "String" },
    { name = "dev.roboshop.user.REDIS_HOST", value = "dev-elasticache-cluster.brptzv.0001.use1.cache.amazonaws.com", type = "String" },
    { name = "dev.roboshop.cart.REDIS_HOST", value = "dev-elasticache-cluster.brptzv.0001.use1.cache.amazonaws.com", type = "String" },
    ...
    { name = "dev.roboshop.shipping.CART_ENDPOINT", value = "cart-dev.ayeeshadevops75.online:80", type = "String" },
    ...
    { name = "dev.roboshop.rds.endpoint", value = "dev-mysql.cluster-cmzmzlxo5mcv.us-east-1.rds.amazonaws.com", type = "String" },
